BUILD_PKGS="gcc g++ gfortran make omniorb omniidl libomniorb4-dev git autoconf automake libtool cmake default-jre-headless gettext libexpat-dev libblas-dev liblapack-dev liblpsolve55-dev libreadline-dev libncurses5-dev libcurl4-openssl-dev libcurl3 libqt4-dev libsundials-serial-dev python-pip"
